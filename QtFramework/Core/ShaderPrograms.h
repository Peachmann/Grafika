...
namespace cagd
{
    ...
    public:
        ...
        GLboolean SetUniformVariable1fv(const GLchar *name, GLint count, GLfloat* params) const;
        GLboolean SetUniformVariable2fv(const GLchar *name, GLint count, GLfloat* params) const;
        GLboolean SetUniformVariable3fv(const GLchar *name, GLint count, GLfloat* params) const;
        GLboolean SetUniformVariable4fv(const GLchar *name, GLint count, GLfloat* params) const;

        GLboolean SetUniformVariable1iv(const GLchar *name, GLint count, GLint* params) const;
        GLboolean SetUniformVariable2iv(const GLchar *name, GLint count, GLint* params) const;
        GLboolean SetUniformVariable3iv(const GLchar *name, GLint count, GLint* params) const;
        GLboolean SetUniformVariable4iv(const GLchar *name, GLint count, GLint* params) const;

        GLboolean SetUniformVariableMatrix2fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat * value) const;
        GLboolean SetUniformVariableMatrix3fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat * value) const;
        GLboolean SetUniformVariableMatrix4fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat * value) const;
        GLboolean SetUniformVariableMatrix2x3fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat * value) const;
        GLboolean SetUniformVariableMatrix3x2fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat * value) const;
        GLboolean SetUniformVariableMatrix2x4fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat * value) const;
        GLboolean SetUniformVariableMatrix4x2fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat * value) const;
        GLboolean SetUniformVariableMatrix3x4fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat * value) const;
        GLboolean SetUniformVariableMatrix4x3fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat * value) const;
