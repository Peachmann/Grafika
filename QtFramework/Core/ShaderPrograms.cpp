...
GLboolean ShaderProgram::SetUniformVariable1f(const GLchar *name, GLfloat parameter) const
{
    ...
    if(location == -1)
        return GL_FALSE;
    cout<<"Location OK"<<endl;


    glUniform1f(location, parameter);
    cout<<"Setting " << location << " to " << parameter << endl;
...
GLboolean ShaderProgram::SetUniformVariable4f(const GLchar *name, GLfloat parameter_1, GLfloat parameter_2, GLfloat parameter_3, GLfloat parameter_4) const
{
    ...
    GLfloat asd[5];
    glGetUniformfv(_program, location, asd);
    ...
    cout<<"Inserted : " << parameter_1 <<" "<<parameter_2 << " " <<parameter_3 << " " << parameter_4<< endl;
...
GLboolean ShaderProgram::SetUniformVariable4fv(const GLchar *name, GLint count , GLfloat *params) const
{
    if (!_program)
        return GL_FALSE;
    ...
    glUniform4fv(location, 4, params);
...
GLboolean ShaderProgram::SetUniformVariable3fv(const GLchar *name, GLint count , GLfloat *params) const
{
    if (!_program)
        return GL_FALSE;
    ...
    glUniform3fv(location, count, params);
...
GLboolean ShaderProgram::SetUniformVariable2fv(const GLchar *name, GLint count , GLfloat *params) const
{
    if (!_program)
        return GL_FALSE;
    ...
    glUniform2fv(location, count, params);
...
GLboolean ShaderProgram::SetUniformVariable1fv(const GLchar *name, GLint count , GLfloat *params) const
{
    if (!_program)
        return GL_FALSE;
    ...
    glUniform1fv(location, count, params);
...
GLboolean ShaderProgram::SetUniformVariable4iv(const GLchar *name, GLint count , GLint *params) const
{
    if (!_program)
        return GL_FALSE;
    ...
    GLint asd[5];
    glGetUniformiv(_program, location, asd);
    cout<<"Current parameters: \n";
    for(int i  = 0 ; i < count; i++)
    {
        cout<<asd[i]<<" ";
    ...
    glUniform4iv(location, 4, params);
...
GLboolean ShaderProgram::SetUniformVariable3iv(const GLchar *name, GLint count , GLint *params) const
{
    if (!_program)
        return GL_FALSE;
    ...
    glUniform4iv(location, 3, params);
...
GLboolean ShaderProgram::SetUniformVariable2iv(const GLchar *name, GLint count , GLint *params) const
{
    if (!_program)
        return GL_FALSE;
    ...
    glUniform4iv(location, 2, params);
...
GLboolean ShaderProgram::SetUniformVariable1iv(const GLchar *name, GLint count , GLint *params) const
{
    if (!_program)
        return GL_FALSE;
    ...
    glUniform4iv(location, 1, params);
...
GLboolean ShaderProgram::SetUniformVariableMatrix2fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix3fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix4fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix2x3fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix3x2fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix2x4fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix4x2fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix3x4fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix4x3fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
    if (!_program)
        return GL_FALSE;
